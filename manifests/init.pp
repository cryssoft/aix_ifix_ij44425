...
#       7.2.5.3    IJ44425m4a.221220.epkg.Z  key_w_fix
#       7.2.5.4    IJ44425m4a.221220.epkg.Z  key_w_fix
#       7.2.5.5    IJ44425s5a.221220.epkg.Z  key_w_fix
...
#       -----------------------------------------------
#       3.1.2.21    IJ44423m2a.221220.epkg.Z  key_w_fix
#       3.1.2.30    IJ44423m2a.221220.epkg.Z  key_w_fix
#       3.1.2.40    IJ44423m2a.221220.epkg.Z  key_w_fix
#       3.1.3.10    IJ44425m4a.221220.epkg.Z  key_w_fix
#       3.1.3.14    IJ44425m4a.221220.epkg.Z  key_w_fix
#       3.1.3.21    IJ44425m4a.221220.epkg.Z  key_w_fix
#       3.1.4.10    IJ44425s5a.221220.epkg.Z  key_w_fix
#
#
#-------------------------------------------------------------------------------
#
class aix_ifix_ij44425 {
    ...
    if ($::facts['osfamily'] == 'AIX') {
        ...
        if (($ifixSuffix != 'unknown') and ($ifixBuildDate != 'unknown')) {
            ...
            unless ($ifixFullName in $::facts['aix_ifix'].keys) {
                ...
                $ifixStagingSource = "puppet:///modules/aix_ifix_ij44425/${ifixName}${ifixSuffix}.${ifixBuildDate}.epkg.Z"
